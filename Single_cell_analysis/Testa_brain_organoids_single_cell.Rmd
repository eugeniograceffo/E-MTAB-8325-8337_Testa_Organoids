...
VlnPlot(merged_seurat_integrated, features = c("FAM107A"))
FeaturePlot(merged_seurat_integrated, features = c("FAM107A"))
```
```{r}
...
VlnPlot(merged_seurat_integrated, features = c("ANK3", "NOVA1"))
FeaturePlot(merged_seurat_integrated, features = c( "ANK3", "NOVA1"))
...
VlnPlot(merged_seurat_integrated, features = c("SOX10", "OLIG1", "OLIG2", "MBP"))
FeaturePlot(merged_seurat_integrated, features = c("SOX10", "OLIG1", "OLIG2", "MBP"))

```
```{r}
## Astrocytes markers (cluster x)
VlnPlot(merged_seurat_integrated, features = c("GFAP", "SLC1A3", "ATP1B2", "SLC1A2"))
FeaturePlot(merged_seurat_integrated, features = c("GFAP", "SLC1A3", "ATP1B2", "SLC1A2"))

```
```{r}
## Radial Glia (cluster 3 and 4)
VlnPlot(merged_seurat_integrated, features = c("VIM", "EDNRB", "SOX3", "ZFP36L1")) 
FeaturePlot(merged_seurat_integrated, features = c("VIM", "EDNRB", "SOX3", "ZFP36L1")) 
```
